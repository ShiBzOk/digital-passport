...
function Sidebar() {
  return (
    <aside className="sidebar">
      <div className="logo" style={{ background: 'transparent', width: '45px', height: '45px' }}>
        <svg 
          viewBox="0 0 512 512" 
          width="100%" 
          height="100%" 
